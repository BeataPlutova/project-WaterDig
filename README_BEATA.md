...
* data pre-processing
For climate data:
connect with API - Filter to required period (1991 – 2022) - Select parameters (Temperature, Precipitation, Snow depth…) - Download into file (excel or csv) - Check for the missing values - handle -1 values - Aggregate to monthly/seasonal/annual values
* data - modeling
